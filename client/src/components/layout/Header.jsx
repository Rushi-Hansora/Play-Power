    ...
    <header className="sticky top-0 z-30 bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-6 md:px-10 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 cursor-pointer select-none">
          ...
          <span className="text-[#FF385C] font-bold text-xl tracking-tight hidden sm:inline">
            airbnb
          </span>
        </div>

        {/* Center Search Pill */}
        <div className="flex items-center border border-gray-300 rounded-full py-2 px-4 shadow-xs hover:shadow-md transition cursor-pointer text-sm font-medium">
          <button className="px-3 border-r border-gray-200 text-gray-900 font-semibold">
            Anywhere
          </button>
          <button className="px-3 border-r border-gray-200 text-gray-900 font-semibold">
            Any week
        ...
        <div className="flex items-center gap-3 relative">
          {/* AI Travel Concierge quick action button */}
          <button
          ...
          <button
            ...
            className="p-2.5 text-gray-700 hover:bg-gray-100 rounded-full transition"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 border border-gray-300 rounded-full p-2 hover:shadow-md transition cursor-pointer"
          >
          ...
          {/* Dropdown Menu */}
          {isMenuOpen && (
            <div className="absolute right-0 top-14 w-60 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50 text-sm animate-in fade-in zoom-in-95 duration-150">
              <button
                onClick={() => {
                  setIsMenuOpen(false);
                  openConcierge();
                }}
                className="w-full text-left px-4 py-2.5 font-semibold text-purple-700 hover:bg-purple-50 flex items-center gap-2"
              >
